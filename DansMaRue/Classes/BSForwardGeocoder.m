...
- (void) setFwdGeocoderDelegate:(id<BSForwardGeocoderDelegate>)_delegate
{
...
-(void)startGeocoding
{
	...
	if(parseError != nil)
	{
		if(delegate != nil && [delegate respondsToSelector:@selector(forwardGeocoderError:)])
		{
			if (delegate != nil) {
		...
		if(delegate != nil && [delegate respondsToSelector:@selector(forwardGeocoderFoundLocation)])
		{
			if (delegate != nil) {
